...
export const CvStyleOne = (props) => {
  const {archivoJSON} = props;
  
  const color_left = archivoJSON.colors? archivoJSON.colors.color_left: '#3498DB';
  const color_left_text = archivoJSON.colors ? archivoJSON.colors.color_left_text: '#000000';
  const color_right = archivoJSON.colors ? archivoJSON.colors.color_right: '#00AAE4';
  const color_right_text = archivoJSON.colors ? archivoJSON.colors.color_right_text: '#FFFFFF';
  const color_component = archivoJSON.colors ? archivoJSON.colors.color_component: '#00AAE4';
    ...
    contenido_base: {
      ...
      container_texto:{
        ...
        linea: {
          ...
          height: '6%', // La línea ocupa toda la altura disponible
        ...
        <Page size={[595.28, Infinity]} style={styles.page}>
          ...
          <View style={styles.contenido_base.main}>
            <View style={styles.contenido_base.fondo}>
              ...
              {(archivoJSON.formaciones ? (archivoJSON.formaciones.formacion.profesiones.profesion.length > 0 || archivoJSON.formaciones.formacion.certificados.certificado.length > 0) : '') && (
                <View style={styles.contenido_base.container}>
                  <Text style={styles.contenido_base.title}>{archivoJSON.formaciones.titulo}</Text>
                  {archivoJSON.formaciones.formacion.profesiones.profesion && archivoJSON.formaciones.formacion.profesiones.profesion.length > 0 && (
                  ...
                  {archivoJSON.formaciones.formacion.certificados.certificado && archivoJSON.formaciones.formacion.certificados.certificado.length > 0 && (
                    <View style={styles.contenido_base.sub_fondo}>
          ...
          <View style={styles.contenido_base.center}></View>
        </Page>
      </Document>
    </PDFViewer>
  );
